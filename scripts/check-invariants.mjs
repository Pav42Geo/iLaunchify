...
const FSM_ALLOWLIST = new Set([
  ...
  // products/actions.ts setProductPaused now gates via isProductTemplateTransitionAllowed
  // (FSM_GUARD_RX), so the whole file is guarded and the old per-line exception is retired.
