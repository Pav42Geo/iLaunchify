...
const PKGS = ['packages/marketplace/src', 'packages/orders/src', 'packages/payments/src', 'packages/nutrition/src', 'packages/ui/src/lib', 'packages/shipping/src', 'packages/risk/src', 'packages/channels/src', 'packages/packaging-3d/src', 'packages/plans/src', 'packages/audit/src']
