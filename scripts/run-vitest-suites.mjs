...
const PKGS = ['packages/orders/src', 'packages/payments/src', 'packages/nutrition/src', 'packages/ui/src/lib', 'packages/shipping/src', 'packages/channels/src', 'packages/packaging-3d/src']
