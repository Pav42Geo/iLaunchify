...
- [ ] Publish + checkout graph pre-flight gates (§8 validator) · per-hop shipping — **PAVEL DECIDED 2026-07-06: printer→applier hop freight bills to the creator's SHIPPING line; summary keeps ONE Shipping line with expandable per-hop breakdown** **[CW; checkout/manifest touchpoints coordinated]**
