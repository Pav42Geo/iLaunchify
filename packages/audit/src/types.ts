...
export const AUDIT_ENTITY_TYPES = [
  ...
  // Shared Design Workspace W0 (2026-07-13) — invited-designer seats
  'DesignCollaborator', // designer seat grant/accept/revoke (NDA-gated)
  'DesignReviewRequest', // C7 internal designer⇄creator review loop
...
export const AUDIT_ACTIONS = [
  ...
  'INTEREST_UNSHORTLISTED', // un-star returns SHORTLISTED → SUBMITTED
  'INTEREST_SELECTED',
  'INTEREST_PASSED',
  'INTEREST_WITHDRAWN',
  ...
  'COCREATION_PRODUCT_MATERIALIZED', // CLOSED_WON → template-less Product + Recipe
  'MILESTONE_FUNDED',
  'MILESTONE_RELEASED',
  'MILESTONE_REFUNDED',
  'MILESTONE_DISPUTED',
