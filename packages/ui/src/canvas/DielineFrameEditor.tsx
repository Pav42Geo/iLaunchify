  ...
  const queueSave = useCallback(
    (nextLayout: FrameLayout, nextTrim: NormBox, nextSafe: NormBox) => {
      ...
      saveTimer.current = setTimeout(async () => {
        ...
        // Shared component — surface failures via saveStatus + console (no app toast dep).
        if (!r.ok && r.error && typeof console !== 'undefined') console.warn('Die-line save failed:', r.error)
      }, 700)
    },
    [onPersist],
  )
