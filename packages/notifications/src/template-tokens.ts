...
export const EVENT_TOKEN_PALETTE: {
  ...
  BUILD_OBJECT_SUBMITTED: ['roomId', 'objectKind', 'version', 'byName'],
  BUILD_OBJECT_CHANGES_REQUESTED: ['roomId', 'objectKind', 'version', 'byName', 'note'],
  BUILD_OBJECT_APPROVED: ['roomId', 'objectKind', 'version', 'byName'],
  ...
  // PS-8b / PS-7 §8.4 — template auto-paused (reason-branched)
