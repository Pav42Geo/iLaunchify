---
description: Build or upgrade an admin list page to the locked v2 surface pattern (cream hero + 5 KPIs + chip filters + sortable table + RowActionsMenu). Alias of /v2-surface.
