...
export function DeleteSubcategoryButton({
  ...
  return (
    <button
      ...
      aria-label={`Delete ${name}`}
      title={error ?? `Delete ${name}`}
      className="inline-flex h-6 w-6 items-center justify-center rounded-full text-danger-600 transition-colors hover:bg-danger-50 hover:text-danger-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-1 disabled:opacity-50"
    >
