  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <h1 className="text-ui-title">{ct.name}</h1>
        <div className="mt-1 flex flex-wrap items-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 rounded-full border border-success-200 bg-success-50 px-3 py-1 text-ui-caption font-medium text-success-700 hover:bg-success-100"
          >
