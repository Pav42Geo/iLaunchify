  ...
  return (
    <div className="space-y-6">
      <header className="rounded-2xl border border-ink-200 bg-[var(--bg-hero)] px-6 py-4">
        ...
        <h1 className="mt-1 font-display text-xl font-bold leading-tight tracking-[-0.02em] text-ink-900">Fees &amp; Commissions</h1>
        <p className="mt-1 max-w-3xl text-[13px] text-ink-600">iLaunchify&rsquo;s platform commission on creator orders. Applies to new orders — no deploy needed.</p>
      </header>
