  ...
  return (
    <div className="space-y-6">
      <header className="rounded-3xl border border-ink-200 bg-cream px-6 py-6">
        <p className="inline-flex items-center gap-1.5 text-[10.5px] font-semibold uppercase tracking-[0.18em] text-ink-500"><DollarSign className="h-3 w-3" /> Order settings</p>
