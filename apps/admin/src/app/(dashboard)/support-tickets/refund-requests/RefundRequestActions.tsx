  ...
  return (
    <div className="flex justify-end gap-2">
      <button
        ...
        onClick={approve}
        disabled={pending}
        className="inline-flex items-center gap-1 rounded-full bg-success-600 px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-success-700 disabled:opacity-50"
      >
