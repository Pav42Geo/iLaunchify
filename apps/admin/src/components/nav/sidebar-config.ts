  ...
  items: [
    ...
    // scans as groups. Category review moved in here from top-level (Pavel 2026-07-04).
    {
      ...
      children: [
        ...
        { kind: 'item', label: 'Access requests', icon: SlidersHorizontal, href: '/settings/partner-access?tab=requests', badgeKey: 'partnerAccess.pending', capability: 'platform:admin' },
    ...
    // ---- Settings — now also holds Languages & Markets + Communications -----
    {
      ...
      children: [
        ...
        // Partner Access & Opportunity console — global policy + bulk list. Absorbed
        // the retired "Partner Profiles" gate (PartnerProfileSetting → PartnerAccessPolicy,
        // 2026-07-14); /settings/partner-profiles now permanent-redirects here.
