...
// Right cluster for the admin dashboard topbar — same shape as the
// creator + partner variants (REBUILD R1).
//
// Admin gets notifications + user dropdown. No favorites / brand switcher.
