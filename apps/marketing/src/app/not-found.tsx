// 404 page for the marketing app. A real not-found UI so an unmatched route
// shows a usable page instead of Next's "missing required error components" loop.

export default function NotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 py-16 text-center">
      <p className="font-display text-5xl font-bold text-ink-900">404</p>
      <h1 className="mt-3 max-w-xl font-display text-xl font-semibold text-ink-900">
