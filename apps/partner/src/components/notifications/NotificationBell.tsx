...
// Notification bell + dropdown for the partner topbar.
// Polls /api/notifications/feed every 30s for unread + recent rows.
// Click a notification → mark read + navigate to link.
