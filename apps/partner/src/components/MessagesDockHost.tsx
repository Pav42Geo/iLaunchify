...
// Messages dock host — PARTNER side (Pavel 2026-07-13). Mounts the stacked
// mini-chat windows on Co-Creation Studio routes only. Thin binding:
// MessagesDock (ui) ← this app's messages server actions — the SAME actions
// the full hub uses, so the dock and the hub can never disagree.
