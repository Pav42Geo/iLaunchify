// /services/manufacturing — now a THIN REDIRECT into the Services hub (Option 1,
// 2026-07-20). The full builder is embedded in the Services page MANUFACTURING
// "capabilities" tab, so this old URL just forwards there (old links keep working).
// If the partner has no manufacturing service, show the empty state.
...
export default async function ManufacturingBuilderPage() {
  ...
  if (initial) redirect(`/services?svc=${initial.serviceId}&sec=capabilities`)
