  ...
  return (
    <li className="rounded-md border border-ink-200 bg-white p-3">
      <div className="flex items-start gap-3">
        <Box className="mt-0.5 h-4 w-4 flex-shrink-0 text-ink-500" />
    ...
    <div className="space-y-3 rounded-md border border-emerald-200 bg-emerald-50/40 p-3">
      <div className="space-y-1">
        ...
        <select
          ...
          disabled={isPending}
          className="w-full rounded-md border border-ink-300 bg-white px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
        >
          {options.map((o) => (
