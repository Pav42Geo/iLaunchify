  ...
  return (
    <div className="grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
      ...
      <div className="card">
        ...
        <h3 style={{ margin: '6px 0' }}>{data.labelArtifact} <i className="info" data-tip={`Auto-selected from the ${data.domainLabel.toLowerCase()} domain · drives the compliance rule pack.`} tabIndex={0} role="img" aria-label="About label regime">i</i></h3>
        {data.ageGroupLabel && (
