...
export function NotesCard({ draftId }: { draftId: string | null }) {
  ...
  return (
    <div className="card">
      <div className="section-title"><span className="ic"><MessageSquare size={16} strokeWidth={2} /></span> Notes <span className="muted" style={{ fontWeight: 400, fontSize: 12 }}>· admin ↔ you</span> <i className="info" data-tip="Messages between your team and the iLaunchify review admins about this product." tabIndex={0} role="img" aria-label="About notes">i</i></div>
