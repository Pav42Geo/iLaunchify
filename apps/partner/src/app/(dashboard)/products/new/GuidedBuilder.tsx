...
.gb .banner{display:flex;gap:10px;align-items:center;border:1px solid #B5D4F4;background:var(--sky-50);color:#0C447C;border-radius:14px;padding:10px 14px;font-size:var(--fs-sm);margin-bottom:16px}
