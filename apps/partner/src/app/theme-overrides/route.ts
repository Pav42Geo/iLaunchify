...
// global ⊕ partner (published), or the partner/global DRAFT when previewing.
...
export async function GET() {
  ...
  const [base, logos] = await Promise.all([getEffectiveThemeCss('partner', previewScope), getPublicBrandLogos()])
  // The Packaging Studio reads the uploaded compact mark via this CSS var.
