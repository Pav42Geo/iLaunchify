...
export function OrderSummary({ state, estimate, shipping, currentStep }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      {currentStep === 2 && <SubscribeAndSaveStub />}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-[11.5px] leading-snug text-ink-600">
            Lock in a recurring production cadence and save up to 12% on every
            run. We&apos;ll re-route automatically as your forecast grows.
          </p>
          <button
            type="button"
            disabled
