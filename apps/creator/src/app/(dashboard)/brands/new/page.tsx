// Step 4 landing — "Brand quickstart" — minimal scope per
// docs/DESIGN_STUDIO_REBUILD.md §4 (corrected 2026-05-26):
...
//
// Full asset library (logos + colors + fonts) lives at /brands/[id]/assets
// after creation. The BrandStylePreset / ColorPalette / TypographyPair picker
// that used to surface here was dropped (web-design-system scope).
