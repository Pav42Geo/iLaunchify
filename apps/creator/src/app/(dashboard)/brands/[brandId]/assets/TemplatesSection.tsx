...
export function TemplatesSection({
  ...
  return (
    <section className="space-y-3">
      ...
      {atCap && (
        <p className="inline-flex items-center gap-1.5 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-[12px] text-amber-800">
              ...
              <div key={t.id} className="overflow-hidden rounded-xl border border-ink-200 bg-white">
                ...
                <div className="flex items-center justify-between gap-2 px-3 py-2">
                  ...
                  <button
                    ...
                    className="shrink-0 text-ink-400 hover:text-red-600 disabled:opacity-50"
                  >
