...
// Global error boundary — catches errors in the ROOT layout itself (which the
// segment error.tsx cannot). Renders its own <html>/<body> with inline styles so
// it works even if the app CSS or a shared package is the thing that failed.
...
export default function GlobalError({
  ...
  useEffect(() => {
    console.error('[creator] global error:', error)
  }, [error])
